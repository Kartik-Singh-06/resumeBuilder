...
const Toaster = ({
  ...
  return (
    (<Sonner
      theme={theme}
      className="toaster group bg-[#007bff9f] text-white"
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:bg-[#007AFF] group-[.toaster]:text-white group-[.toaster]:border-neutral-200 group-[.toaster]:shadow-lg dark:group-[.toaster]:bg-neutral-950 dark:group-[.toaster]:text-neutral-50 dark:group-[.toaster]:border-neutral-800",
